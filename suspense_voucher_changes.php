			...
			<div class="card-header">
				<div class="row p-2">
					<div class="col-lg-8 col-md-8 col-8 align-self-center">
						<div class="h5">Add Suspense Voucher</div>
					</div>
					<div class="col-lg-4 col-md-4 col-4">
						<button class="btn btn-dark float-end" style="font-size:11px;" type="button" onclick="window.open('suspense_voucher.php','_self')"> <i class="fa fa-arrow-circle-o-left"></i> &ensp; Back </button>
					</div>
				</div>
			</div>
            <div class="row p-3">
                            ...
                            <div class="form-group pb-2">
                                <div class="form-label-group in-border mb-0">
                                    <select class="select2 select2-danger" data-dropdown-css-class="select2-danger" style="width: 100%;">
                                        <option>Select Suspense Party</option>
                                        <option>Mahesh Prabhu</option>
                                        <option>Vinoth Kumar</option>
                                    </select>
                                    <label>Select Suspense Party</label>
                                </div>
                            </div>        
                        </div>
                        <div class="col-lg-2 col-md-3 col-12">
