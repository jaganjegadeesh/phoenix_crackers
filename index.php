...
<head>
    <meta charset="utf-8">
    <title>Dashboard | Phoenix Crackers</title>
                ...
                <div class="col-lg-12">
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <a href="index.php" class="d-inline-block auth-logo">
                            <h1 class="text-white">Phoenix Crackers</h1>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card mt-4">
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign <?php if(!empty($users_count)) { ?>in<?php } else { ?>up<?php } ?> to continue to Phoenix Crackers.</p>
                            </div>
                            <div class="p-2 mt-4">
                                                ...
                                                <div class="mb-3">
                                                    <div class="form-group mb-1">
                                                        <div class="form-label-group in-border">
                                                            <input type="text" name="username" class="form-control shadow-none login_controls" value="" placeholder="">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-label-group in-border">
                                                            <div class="input-group">
                                                                <input type="password" class="form-control shadow-none login_controls" id="password" name="password" value="" placeholder="Password">
                                        ...
                                        <div class="row">
                                            <div class="col-10 mx-auto">
                                                <div class="form-group mb-1 pb-3">
                                                    <div class="form-label-group in-border">
                                                        <input type="text" name="name" class="form-control shadow-none login_controls" value="" onkeydown="Javascript:KeyboardControls(this,'text',25,1);" placeholder="">
                                            ...
                                            <div class="col-10 mx-auto">
                                                <div class="form-group mb-1 pb-3">
                                                    <div class="form-label-group in-border">
                                                        <input type="text" name="mobile_number" class="form-control shadow-none login_controls" value="" placeholder="" onkeydown="Javascript:KeyboardControls(this,'mobile_number',10,'');">
                                            ...
                                            <div class="col-10 mx-auto">
                                                <div class="form-group mb-1 pb-3">
                                                    <div class="form-label-group in-border">
                                                        <input type="text" name="login_id" class="form-control shadow-none login_controls" value="" placeholder="" onkeydown="Javascript:KeyboardControls(this,'text',25,1);">
                                            ...
                                            <div class="col-10 mx-auto">
                                                <div id="password_cover" class="form-group mb-1 pb-3">
                                                    <div class="form-label-group in-border">
                                                        <div class="input-group">
                                                            <input type="password" class="form-control shadow-none login_controls" id="password" name="password" value="" placeholder="Password" onkeyup="Javascript:CheckPassword('password');" onfocus="Javascript:KeyboardControls(this,'password',20,'');" onkeydown="Javascript:InputBoxColor(this,'text');">
                                                            <label for="password">Password <span class="text-danger">*</span></label>
                                                            <div style="position: inherit; top: 0px;" class="input-group-append" data-toggle="tooltip" data-placement="right" title="Show Password">
