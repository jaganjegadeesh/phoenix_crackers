        ...
        <form class="poppins pd-20 redirection_form" name="payment_mode_form" method="POST">
			...
			<div class="row justify-content-center p-3">
                        ...
                        <div class="col-lg-5 col-md-8 col-12">
                            <div class="form-label-group in-border">
                                <div class="input-group mb-1">
                                    <input type="text" id="payment_mode_name" name="payment_mode_name"   class="form-control shadow-none" value="<?php if(!empty($payment_mode_name)){echo $payment_mode_name;} ?>" onkeydown="Javascript:KeyboardControls(this,'text',15,'');" onkeyup="Javascript:InputBoxColor(this,'text');">
                                    <label>Payment Mode <span class="text-danger">*</span></label>
                                    <?php if(empty($show_payment_mode_id)){ ?>
                                        <div class="input-group-append">
                                            <button class="btn btn-dark" type="button" onClick="Javascript:addCreationDetails('payment_mode', 15);"><i class="fa fa-plus"></i></button>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                ...
                <div class="col-md-12 pt-3 text-center">
                    <button class="btn btn-danger submit_button" type="button" onClick="Javascript:SaveModalContent(event,'payment_mode_form', 'payment_mode_changes.php', 'payment_mode.php');">
                        Submit
                    </button>
                </div>
			</div>
                                    ...
                                    <td>
                                        ...
                                        <?php 
                                            ...
                                            if(empty($delete_access_error)) {
                                                ...
                                                <?php }else{ ?>
                                                    <li><a class="dropdown-item"   style="cursor:pointer;"  onclick="Javascript:DeleteModalContent('<?php if(!empty($page_title)) { echo $page_title; } ?>', '<?php if(!empty($list['payment_mode_id'])) { echo $list['payment_mode_id']; } ?>');"><i class="fa fa-trash"></i> &ensp;  Delete</a></li>
                                                <?php } 
