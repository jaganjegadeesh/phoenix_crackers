            ...
            if(preg_match("/^\d+$/", $check_user_id_ip_address)) { 
                ...
                if(empty($edit_id)) {
                    if(empty($prev_account_number)) {						
                        ...
                        $columns = array('created_date_time', 'creator', 'creator_name', 'bill_company_id', 'bank_id','account_name', 'account_number', 'bank_name', 'ifsc_code','account_type','bank_name_account_number','branch','payment_mode_id','opening_balance','opening_balance_type','deleted');
                        $values = array("'".$created_date_time."'", "'".$creator."'", "'".$creator_name."'", "'".$bill_company_id."'", "'".$null_value."'", "'".$account_name."'", "'".$account_number."'","'".$bank_name."'","'".$ifsc_code."'","'".$account_type."'","'".$bank_name_account_number."'","'".$branch."'","'".$payment_mode_ids."'","'".$opening_balance."'","'".$opening_balance_type."'","0");
                    ...
                    if(empty($prev_bank_id) || $prev_bank_id == $edit_id) {
						if(empty($prev_account_number) || $prev_account_number == $edit_id){
                            ...
                            if(preg_match("/^\d+$/", $getUniqueID)) {
                                ...
                                $columns = array(); $values = array();						
                                $columns = array('creator_name','account_name', 'account_number', 'bank_name', 'ifsc_code','account_type','bank_name_account_number','branch','payment_mode_id','opening_balance','opening_balance_type',);
                                $values = array("'".$creator_name."'","'".$account_name."'", "'".$account_number."'","'".$bank_name."'","'".$ifsc_code."'","'".$account_type."'","'".$bank_name_account_number."'","'".$branch."'","'".$payment_mode_ids."'","'".$opening_balance."'","'".$opening_balance_type."'");
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                    ...
                                                    ?>
                                                    <li><a class="dropdown-item" style="cursor:pointer;" href="Javascript:ShowModalContent('<?php if(!empty($page_title)) { echo $page_title; } ?>', '<?php if(!empty($list['bank_id'])) { echo $list['bank_id']; } ?>');"><i class="fa fa-pencil"></i> &ensp;  Edit</a></li>
                                                    <?php } 
                                                    ...
                                                    <?php }else{ ?>
                                                        <li><a class="dropdown-item" style="cursor:pointer;" onclick="Javascript:DeleteModalContent('<?php if(!empty($page_title)) { echo $page_title; } ?>', '<?php if(!empty($list['bank_id'])) { echo $list['bank_id']; } ?>');"><i class="fa fa-trash"></i> &ensp; Delete</a></li>
                                                <?php  } 
